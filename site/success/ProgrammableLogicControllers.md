...
![](/files/success/2016-IDE4PLC.jpg width=800px)
IDE4PLC \([https://ide4plc.wordpress.com/](https://ide4plc.wordpress.com/)\) is a programming environment for Programmable Logic Controllers \(PLC\), a family of embedded computers widely used for automation tasks in industrial environments. It supports the graphical language Ladder, allowing a user experience similar to that given by mainstream commercial tools. IDE4PLC is based on an abstract model of a controller, what enables it to support different controller architectures, and on a software model that strictly complies the IEC 61131-3 standard.
It is a free, open, and multiplatform \(Windows, Linux, IOS\) product, contrary to most PLC programming environments and tools, which are tightly coupled with device vendors. This product is developed mainly by Eric Pernia. Carlos Lombardi collaborates with the software design.
...
_The combination of the agility of the programming experience in Pharo, the features given by Morphic for flexible and interactive UI, and the modeling power of object-oriented design, allowed to craft IDE4PLC in one person-year, an order of magnitude less time than what can be expected using more traditional tools and methodologies.
The ability to explore the software model of a running IDE4PLC instance, and to perceive the effects of code change immediately, were crucial for the success of this project_. Carlos Lombardi.
